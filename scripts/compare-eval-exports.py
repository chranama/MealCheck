...
The input files should come from:

  mealcheck eval-normalization -export-jsonl ...
  mealcheck eval-checker -export-jsonl ...

The tool intentionally consumes the flat export rows rather than the aggregate
JSON result so operators can compare individual cases across commits.
"""
