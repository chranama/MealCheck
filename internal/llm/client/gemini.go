...
func geminiSystemInstruction(messages []Message) map[string]any {
...
func (p Gemini) Complete(ctx context.Context, config ProviderConfig, request Request) (string, error) {
	if config.APIKey == "" {
